          ...
          <b-table
            ...
            <template v-slot:head(actions)>
              <feather
                ...
                size="22px"
                fill="#4050F6"
                @click="addRecord()"></feather>
              <feather
                v-if="add"
                type="search"
                stroke-width="6"
                size="22px"
                @click="searchData()"></feather>
            </template>
          </b-table>
        </div>
      </div>
...
export default {
  data() {
    return {
      tablefields: [
        ...
        { key: "transferId", label: "Transfer Id", sortable: false },
  ...
  created() {
    this.$store.dispatch("reports/getTransferData");
  },
  computed: {
    ...mapGetters({
      items: "reports/getTransferData",
    }),
