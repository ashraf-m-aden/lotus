                          ...
                          <div class="table-responsive profile-table mb-0">
                            <table class="table table-responsive mb-0">
                              <tbody>
                                <tr>
                                  <td>Nom:</td>
                                  <td><input type="text" class=" form-control" v-model="update.name" /></td>
                                </tr>
                                <tr>
                                  <td>Mobile Number:</td>
                                  <td><input type="text" class=" form-control" v-model="update.number" /></td>
                                </tr>
                                <tr>
                                  <td>Specialité:</td>
                                  <td><input type="text" class=" form-control" v-model="update.specialite" /></td>
                                </tr>
                                <tr>
                                  <td>
                                    <button class="btn btn-group btn-primary"
                                      @click="updateProfile()">Sauvegarder</button>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            <hr>
                            <p>
                              Changement de mot de passe, veuillez cliquez sur le bouton ci dessous vous recevrez un
                              email de changement de mot de passe.
                            </p>
                            <br>
                            <button class="btn btn-group btn-air-warning" @click="updatePassword()">Envoyez email de mis
                              à jour mot de
                              passe</button>
                          </div>
                        </div>
