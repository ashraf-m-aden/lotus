...
export default {
    ...
    methods: {
        ...
        async sauvegarderAnteObstre() {
            await historiquesPatient.setAnteObstre(this.anteObstre).then(async () => {
                await historiquesPatient.getAnteObstre(this.user.id);
                this.anteObstreModif = !this.anteObstreModif;
            })
        },
