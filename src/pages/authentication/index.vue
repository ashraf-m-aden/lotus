      ...
      <div class="container">
		...
		c-10.173,0-20.251-1.566-29.869-4.586l1.861-5.928h-53.983v12.415l1.255,4.117h144.745V233.765"></path>
                    <path style="fill: #cecece"
                      d="M385.387,217.453c-6.196,2.3-12.551,4.073-18.994,5.313h21.767L385.387,217.453"></path>
		...
		h173.987c-12.828-23.18-33.641-39.288-57.199-46.682C365.898,28.829,355.817,27.261,345.64,27.261"></path>
                    <polyline style="fill: #9f9f9f"
                      points="432.719,78.532 258.732,78.532 258.73,78.535 432.721,78.535 432.719,78.532 	"></polyline>
                    <path style="fill: #cecece"
		...
		C459.3,115.885,440.44,175.955,391.75,201.375z"></path>
                    ...
                    <polyline style="fill: #2be0c6"
                      points="93.6,254.001 57.602,254.001 57.602,343.996 93.6,343.996 93.6,254.001 	"></polyline>
                    <polyline style="fill: #ffbc58"
                    ...
                    <polyline style="fill: #13c9ca"
                      points="242.83,325.765 242.83,454.765 0,454.765 0,325.765 242.83,325.765 	"></polyline>
                    <polyline style="fill: #f2f2f2"
                      points="15,439.765 15,340.765 227.826,340.765 227.826,439.765 15,439.765 	"></polyline>
